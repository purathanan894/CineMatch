  ...
  return (
    <main className="mt-20 w-full max-w-7xl mx-auto p-4 sm:p-6 text-slate-900">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-5">
        {items.map((item) => (
          <div key={item.movie_id || item.id} className="relative bg-white rounded-xl shadow-sm overflow-hidden group h-[320px] transition-transform duration-300 hover:scale-[1.03]">
            <img 
