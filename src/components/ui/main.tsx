        ...
        {items.map((item) => {
          ...
          return (
            <div 
              ...
              className="relative bg-black rounded-xl shadow-lg overflow-hidden aspect-[2/3] cursor-pointer border border-slate-800"
            >
              <img 
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl w-full max-w-md p-6">
            <h3 className="font-black text-slate-800 mb-4 uppercase">Kategorie</h3>
